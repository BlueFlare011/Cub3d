...
/*   Updated: 2023/10/19 18:33:20 by rgallego         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	raycasting(cube);
	mlx_hook(cube->mlx->win, ON_KEYDOWN, MASK, key_down, cube);
	mlx_hook(cube->mlx->win, ON_KEYRELEASE, MASK, key_release, cube);
